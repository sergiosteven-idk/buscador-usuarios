...
export default function Card({usuario}) {
    ...
    return (
        <>
            <div className="p-4 bg-white shadow-md rounded hover:scale-105 transition-transform duration-300 cursor-pointer" onClick={() => setShowModal(true)}>
            ...
            <Modal isOpen={showModal} onClose={() => setShowModal(false)} usuario={usuario} />
        </>
    )
}